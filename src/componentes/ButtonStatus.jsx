...
function ButtonStatus({ status, nombre, id, orden }) {
    ...
    return (
                status == 'true' && nombre == 'Inicio' ? (
                    ...
                    <button onClick={() => handleidbutton(id, orden)} style={{  height: '40px',width: '30px' ,display: 'flex', flexDirection: 'column' , padding: '2px', justifyContent:'center', alignItems:'center', margin: '12px', lineHeight: '6px'}}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                    ...
                    <button disabled style={{ height: '40px',width: '40px',display: 'flex', flexDirection: 'column' , padding: '2px', justifyContent:'center', alignItems:'center',  margin: '4px'}}>
                        ...
                        <span  className='line-clamp-2 font-bold tracking-tighter' style={{ fontSize: '0.5rem' }}>Finalizado</span>
                    </button>
                ) : null
    )
}
